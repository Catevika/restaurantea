...
export default function OrderList() {
  return (
		<div className="bg__black">
			<div className="column order__intro">
				<h6
					className={`${josefinSans.className} border__tb__gold text__uppercase`}
				>
					Our Free Home Delivery Service
				</h6>
				<h5 className={cormorantInfant.className}>
					Your favorite meals within 30min.
				</h5>
			</div>
			<div className="container__color__bg">
				<div className="content__menu__section__img">
					<Image
						src="/images/beverages-top.png"
						alt=""
						width={1400}
						height={431}
						priority
				...
				<div className="content__menu__section__img">
					<Image
						src="/images/main-course-top.png"
						alt=""
						width={1400}
						height={430}
						priority
