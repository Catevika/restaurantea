		...
		<footer className="border__top__gray">
			<div className="container container__footer">
				<div className="content__feed">
					<p className="text__underline">
						<a href="/gallery">Instagram feed</a>
					</p>
				</div>
				<Logo />
				<SocialIcons />
			...
			<div className="column content__footer">
				<p>
					This website is a customized version - for training purpose only - of:
				</p>
				<p>
					© Copyright - Restaurantate | Designed by{" "}
					<Link href="https://www.victorflow.com/">
						<span className="active">VictorFlow</span>
					</Link>{" "}
					Templates - Powered by <span className="active">Webflow</span>
				</p>
			</div>
		</footer>
	);
