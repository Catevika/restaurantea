					...
					<div className="container__color__bg">
						<div className="container container__aboutus">
							<div className="column col__h__start container__about left__50">
								<h6
									className={`${josefinSans.className} text__uppercase border__tb__gold`}
								>
									About us
								</h6>
								<h4 className={cormorantInfant.className}>
							...
							<div className="container__aboutImg">
								...
								<Image
									className="aboutImg"
									src="/images/about-restaurant-hall.png"
									alt=""
									sizes="30vw"
									width={0}
									height={0}
				...
				<div className="container__color__bg">
					<div className="column">
						...
						<div className="container__icon__quote__large">
							<Image
								className="icon__quote__large"
								src="/icons/quote-large.svg"
								alt=""
								width={284}
								height={275}
								priority
