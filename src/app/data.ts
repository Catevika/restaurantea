...
export const offers = [
  {
    ...
    "imgSrc": "/images/burger-offer.png",
    "imgWidth": 465,
    "imgHeight": 419,
...
export const recipes = [
	{
		...
		slug: "starter-avocado",
		ingredients:
			"1 avocado, 1 cooked beet, 2 toasts, 3 small yellow tomatoes, 1 lemon, basil, extra vergin olive oil, balsamic vinegar, Himalaya salt, black pepper, and Cayenne pepper",
		description:
			"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Obcaecati nulla rem voluptatum? Optio quo repellendus cum odio. Explicabo, repellendus quos.",
	},
	{
		id: 73,
		category: "Main course",
	...
	},
	{
		...
		slug: "cheese-burger",
		ingredients:
			"1 burger bun, 180g minced ground beef, 1 red tomato, onions marmalade, 2 slices of mature cheddar, 2 iceberg salad leaves, barbecue or tomato sauce, mustard, hamburger dill chips",
		description:
			"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam tempore nam accusamus, error dignissimos aliquid necessitatibus vero quae exercitationem natus.",
	},
	{
		id: 75,
		category: "Main course",
		...
		slug: "tacos",
		ingredients:
			"3 tortilla (6-inch) or traditional size hard taco shells, 3 chicken fillets, a crumble of queso fresco or cotija cheese, sliced avocados & radishes, shredded lettuce or cabbage, Jalapeños(optional), sour cream, chili powder, salt, pepper",
		description:
			"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nesciunt perspiciatis quasi veritatis omnis perferendis accusamus vitae similique ex iste reiciendis.",
	},
	{
		id: 76,
		category: "Dessert",
		...
		slug: "lemon-pie",
		ingredients:
			"Dough for single-crust pie, 1 cup sugar, 1/4 cup cornstarch, 3 tablespoons all-purpose flour, 1/4 teaspoon salt, 2 cups water, 3 large beaten egg yolks, 1 tablespoon butter, 1/4 cup lemon juice, 1 teaspoon grated lemon zests",
		description:
			"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem sed eaque ratione quam placeat vel, a dolor doloribus excepturi adipisci.",
	},
	{
		id: 77,
		category: "Dessert",
		...
		slug: "brownie-raspberry",
		ingredients:
			"2 eggs + water, flour, powdered sugar, chocolate chips, unsweetened cocoa powder, olive oil, vanilla extract",
		description:
			"Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos reprehenderit voluptatibus earum praesentium molestiae fuga corrupti aliquam ad nostrum cum.",
	},
];
